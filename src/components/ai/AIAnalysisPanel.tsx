      ...
      {!hasApiKey && (
        <div className="flex items-start gap-2 rounded-lg border border-warning/40 bg-warning/5 p-3">
          ...
          <p className="text-xs text-amber-300">
            AI analysis requires <code className="bg-surface px-1 rounded">VITE_ANTHROPIC_API_KEY</code> in{' '}
            <code className="bg-surface px-1 rounded">.env.local</code>. Mock mode shows placeholder output.
          </p>
        </div>
      )}
